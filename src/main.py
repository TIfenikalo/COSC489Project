...
def main():
    ...
    #Turns the wlan0 into monitor mode
    print("Step 2: Starting monitor mode on wlan0...")
    run_command("sudo airmon-ng start wlan0")
   #Used to scan for access points and grab the bssid and channel number
    ...
    #Will grab any handshakes that occur
    ...
    run_command(command)
    #Kicks users off the internet to speed up the proccess of handshakes
    ...
    #Turns the monitor back in managed mode
    ...
    #                                          Depending on where you store your rockyou file will determine this
